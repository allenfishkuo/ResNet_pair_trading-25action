...
def test_testyear():
    ...
    for date in sorted(datelist):
        ...
        for pair in num: #看table有幾列配對 依序讀入
            ...
            open,loss = 1.5,3
            profit,opennum,trade_capital ,_  = trading_period_by_gate_nocheck.pairs( pair ,165,  table , mindata , tickdata , open ,open, loss ,mindata, max_posion , 0.003, 0.01 , 30000000 )
